            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Bentornato Admin</h2>
                        <form method="POST" class="register-form" id="register-form"name="form2" action="../Script/login.php">
                            <input type="hidden" name="form_name" value="form2">
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="nome2" id="nome2" placeholder="Nome" required/>
                            </div>
